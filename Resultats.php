    ...
    if (!isset($_SESSION['username'])) {
      ...
      elseif (($_SESSION['harry']||$_SESSION['ron'] ||$_SESSION['hermione'] ||$_SESSION['neuville'] ||$_SESSION['voldi'] ||$_SESSION['drago']||$_SESSION['dumbi']||$_SESSION['rog']||$_SESSION['luna'] ||$_SESSION['gin']) != 0){
        ...
        $data = array(
            ...
            "Id_Quizz" => 2,);
        insertSQL($table, $data);
        if ($_SESSION['harry']>=$_SESSION['ron'] && $_SESSION['harry']>=$_SESSION['hermione'] && $_SESSION['harry']>=$_SESSION['neuville'] && $_SESSION['harry']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['ron']>=$_SESSION['harry'] && $_SESSION['ron']>=$_SESSION['hermione'] && $_SESSION['ron']>=$_SESSION['neuville'] && $_SESSION['ron']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['hermione']>=$_SESSION['ron'] && $_SESSION['hermione']>=$_SESSION['harry'] && $_SESSION['hermione']>=$_SESSION['neuville'] && $_SESSION['hermione']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['neuville']>=$_SESSION['ron'] && $_SESSION['neuville']>=$_SESSION['hermione'] && $_SESSION['neuville']>=$_SESSION['harry'] && $_SESSION['neuville']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['voldi']>=$_SESSION['ron'] && $_SESSION['voldi']>=$_SESSION['hermione'] && $_SESSION['voldi']>=$_SESSION['neuville'] && $_SESSION['voldi']>=$_SESSION['harry'] 
        ...
        elseif ($_SESSION['drago']>=$_SESSION['ron'] && $_SESSION['drago']>=$_SESSION['hermione'] && $_SESSION['drago']>=$_SESSION['neuville'] && $_SESSION['drago']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['dumbi']>=$_SESSION['ron'] && $_SESSION['dumbi']>=$_SESSION['hermione'] && $_SESSION['dumbi']>=$_SESSION['neuville'] && $_SESSION['dumbi']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['rog']>=$_SESSION['ron'] && $_SESSION['rog']>=$_SESSION['hermione'] && $_SESSION['rog']>=$_SESSION['neuville'] && $_SESSION['rog']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['luna']>=$_SESSION['ron'] && $_SESSION['luna']>=$_SESSION['hermione'] && $_SESSION['luna']>=$_SESSION['neuville'] && $_SESSION['luna']>=$_SESSION['voldi'] 
        ...
        elseif ($_SESSION['gin']>=$_SESSION['ron'] && $_SESSION['gin']>=$_SESSION['hermione'] && $_SESSION['gin']>=$_SESSION['neuville'] && $_SESSION['gin']>=$_SESSION['voldi'] 
      ...
      <h2><?php echo $select['libellePerso']; ?></h2>
        ...
        $data = array(
            ...
            "Id_Quizz" => 4,);
        insertSQL($table, $data);
        $scoreUser = $_SESSION['user'];
        ?>
        <h3> <?php echo ($scoreUser . "/20")?></h3>
        <h2> => <?php $scoresurCent = $scoreUser * 5 ?></h2>
        <?php
